	...
	switch(this.id){
		case 'video':
			div.innerHTML = "<p>Assista ao vídeo demonstrativo da ferramenta:</p>" +
		      '<iframe width="496" height="280" src="https://www.youtube.com/embed/kXYiU_JCYtU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'; 
			break;
...
function cleanLayers(){
	...
	var layers = ['routePhase01', 'routePhase02', 'routePhase03', 'routePoints01', 'bfPhase02', 'txtPath'];
