    ...
    <div style = "flex-grow: 1;display: flex;justify-content: center; align-items: center;">
        <div style = "width: 400px;  color: #74787E;">
            ...
            <div class = "section_body">
                <p style = "text-align:justify;">Data inicial: {{ $body["initial_date"] }}</p>
                <p style = "text-align:justify;">Data final: {{ $body["final_date"] }}</p>
                <p style = "text-align:justify;">Criador: {{ $body["creator"] }}</p>
                <p style = "text-align:justify;">Piloto: {{ $body["pilot"] }}</p>
                <p style = "text-align:justify;">Cliente: {{ $body["client"] }}</p>
            </div>
            <hr>
