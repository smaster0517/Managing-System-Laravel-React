...
export const BatteryInformation = React.memo((props) => {
                ...
                <DialogContent>
                    ...
                    <Grid container columns={12} spacing={1} mb={1}>
                        ...
                        <Grid item xs={12} sm={3}>
                            <TextField
                                margin="dense"
                                defaultValue={props.record.last_charge != "N/A" ? moment(props.record.last_charge).format("DD/MM/YYYY") : props.record.last_charge}
                                label="Criado em"
                                fullWidth
                                variant="outlined"
                                InputProps={{
