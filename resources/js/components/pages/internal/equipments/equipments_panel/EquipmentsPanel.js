 ...
 */
    ...
    AxiosApi.get(`/api/equipments-module-equipment?args=${select_query_params}&auth=${module_middleware}`)
      ...
      .catch(function (error) {
        ...
        if (error.response.status == 404) {
          ...
          handleOpenSnackbar("Nenhum registro de equipamento encontrado!", "error");

        } else {

          handleOpenSnackbar("Erro no carregamento dos dados do painel de equipamentos!", "error");
  ...
  /**
   * Função para processar a pesquisa de equipamentos no input de pesquisa
      ...
      <Grid container spacing={1} alignItems="center" mb={1}>
        ...
        <Grid item>
          ...
          {(panelData.response.records != null && selectedRecordIndex != null) &&
            <UpdateEquipmentFormulary record={panelData.response.records[selectedRecordIndex]} record_setter={setSelectedRecordIndex} reload_table={reloadTable} />
          }
        </Grid>
        ...
        <Grid item>
          ...
          {/* O modal é renderizado apenas quando um registro já foi selecionado */}
          {(panelData.response.records != null && selectedRecordIndex != null) &&
            <DeleteEquipmentFormulary record={panelData.response.records[selectedRecordIndex]} record_setter={setSelectedRecordIndex} reload_table={reloadTable} />
          }
        </Grid>
