...
export const NavigatorToggle = React.memo((props) => {
  ...
  const categories = React.useMemo(() => ([
    ...
    },
    {
      id: "Módulos",
      children: [
        { id: 'Administração', icon: <AdminPanelSettingsIcon />, access: user.user_powers["1"].profile_powers.read == 1 ? true : false, path: "administracao" },
        { id: 'Planos', icon: <MapIcon />, access: user.user_powers["2"].profile_powers.read == 1 ? true : false, path: "planos" },
        { id: 'Ordens', icon: <AssignmentIcon />, access: user.user_powers["3"].profile_powers.read == 1 ? true : false, path: "ordens" },
        { id: 'Relatórios', icon: <AssessmentIcon />, access: user.user_powers["4"].profile_powers.read == 1 ? true : false, path: "relatorios" },
        { id: 'Incidentes', icon: <ReportIcon />, access: user.user_powers["5"].profile_powers.read == 1 ? true : false, path: "incidentes" },
        { id: 'Equipamentos', icon: <HomeRepairServiceIcon />, access: user.user_powers["6"].profile_powers.read == 1 ? true : false, path: "equipamentos" }
      ]
    },
    {
      id: 'Outros',
